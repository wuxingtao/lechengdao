...
//删除选中  --修改删除按钮
$(".total-state1 .shopping-operation .delBtn").on("click", function() {
    //length 判断商城商品和店名
    $("#fav-lists1 .lump-info .proRadius").each(function() {
...
$(".total-state2 .shopping-operation .delBtn").on("click", function() {
    //length 判断商城商品和店名
    $("#fav-lists2 .lump-info .proRadius").each(function() {
        var $parents = $(this).parents(".lumpBox").find(".lump-info").length;   //单店收藏总商品
        var $select =$(this).parents(".lumpBox").find(".pro-selected").length;  //单店选中
