    ...
    /*//state2
    if($(".lumpBox").find(".delRadius")){
        $(".lump-info .delRadius").each(function(){
            $(this).on("click",function(){
                $(this).toggleClass("pro-del-selected");
                var checksdg=$(".lump-info .pro-del-selected").length;
                var checktdt=$(".lump-info .delRadius").length;
        ...
        $("#icon-del-checkAll").on("click",function(){
                ...
                // $(".lump-info .delRadius").toggleClass("pro-selected")
                if($(this).hasClass("icon-del-check")){
                    $(".lump-info .delRadius").addClass("pro-del-selected")
                    shopTotal.addClass("lump-del-selected")
                }else{
                    $(".lump-info .delRadius").removeClass("pro-del-selected")
                    shopTotal.removeClass("lump-del-selected")
                }
        })
    ...
    $(".lumpBox .countPrice").each(function() {
        ...
        //添加
        $(".xCount .xCount-plus", this).click(function(e) {
            var $add = $(this);
            ...
            //
            var total = Number(singlePrice) * num; //总价
            $target.html(total);
            $targetNum.html(num);
            // console.info(total);
        ...
        //删除
        $(".xCount .xCount-minus", this).click(function(e) {
            var $reduce = $(this);
...
var offModel="<div class=\"content-wrap\"><div class=\"entry-title\"><a class=\"featured-image\" rel=\"bookmark\"></a><a class=\"btn btn-close\"><img src=\"../script/images/member/point/check-btn1.png\"></a></div></div>"
var targetG=$(".shopping-confirm-wrapper .lump-info"),
    ...
    if(targetG.find(".goods-take-off")){
        ...
        $(".goods-take-off .btn-close").click(function(){
            $(this).parents(".goods-take-off").remove();
        })
    }
    if(targetS.find(".store-take-off")){
        ...
        $(".store-take-off .btn-close").click(function(){
            $(this).parents(".store-take-off").remove();
        })
    }
